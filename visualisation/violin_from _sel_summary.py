...
#
# # # sel_summary is per model so dont do per unit (e.g., selectivity) stats here.
...
for var_name in IV:
    for measure in DV:
        ...
        if measure is 'combo':
            ...
            measure_root = measure[:-2]
            m_name = f'Highest {measure_root} frequency'
            plot_type = 'countplot'
