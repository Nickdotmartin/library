...
def lesion_study(gha_dict_path,
    ...
    item_correct_df, scores_dict, incorrect_items = hdf_pred_scores(model=original_model,
    ...
    exp_path, cond_name = os.path.split(lesion_summary_dict['topic_info']['exp_cond_path'])
    ...
    ls_info = [date, time, output_filename, run,
